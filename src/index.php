...
<div class="main-layout">
    ...
    <div id="financial-summary-container">
        <div id="financial-summary">
            ...
            <div id="projected-next-rent-line">Future Net Worth (after Next Rent): <span id="projected-nw-next-rent"
                    class="currency">N/A</span></div>
            <div id="projected-next-utils-line">Future Net Worth (after Next Utilities): <span
                    id="projected-nw-next-utils" class="currency">N/A</span></div>
            <!-- End of new lines -->
